...
def build_denoising_unet(noisy_tensor, keep_prob, is_realnoisy, alpha, beta, gamma=0.5, mask_prob=0.5, reg_layer='dec_conv2b'):
    ...
    tf.summary.scalar('edge loss', l_edge)
